...
{
    /// <inheritdoc />
    public partial class MadeEmailrequired1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumWarriors = table.Column<int>(type: "integer", nullable: false),
                    MaximumWarriors = table.Column<int>(type: "integer", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    SpecialRule = table.Column<string>(type: "character varying(600)", maxLength: 600, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillRule = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 4, 21, 12, 37, 8, 705, DateTimeKind.Utc).AddTicks(4104), "testmail1.com", "Test User 1", "Non-hashed-password1", false },
                    { 2, new DateTime(2023, 4, 21, 12, 37, 8, 705, DateTimeKind.Utc).AddTicks(4106), "testmail2.com", "Test User 2", "Non-hashed-password2", false }
                });
        }
