...
{
    /// <inheritdoc />
    public partial class newMigratino : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 28, 10, 48, 23, 277, DateTimeKind.Utc).AddTicks(1747), "testmail1.com", "Test User 1", "Non-hashed-password1", false },
                    { 2, new DateTime(2023, 3, 28, 10, 48, 23, 277, DateTimeKind.Utc).AddTicks(1749), "testmail2.com", "Test User 2", "Non-hashed-password2", false }
                });
        }
